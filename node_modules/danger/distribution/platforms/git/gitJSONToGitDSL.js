...
exports.gitJSONToGitDSL = function (gitJSONRep, config) {
    ...
    var linesOfCode = function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, createdFilesDiffs, modifiledFilesDiffs, deletedFilesDiffs, additions, deletions, modifiedLines;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), createdFilesDiffs = _a[0], modifiledFilesDiffs = _a[1], deletedFilesDiffs = _a[2];
                    ...
                    deletions = deletedFilesDiffs
                        ...
                        .reduce(function (mem, value) { return mem + value; }, 0);
                    modifiedLines = modifiledFilesDiffs.map(function (diff) { return [
